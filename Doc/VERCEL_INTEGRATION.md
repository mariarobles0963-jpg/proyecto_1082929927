...
- Org/Team ID (slug): `your-vercel-team`
- Si necesitas comprobarlos por CLI:
  - `npx vercel projects inspect proyecto_1082929927 --scope your-vercel-team`
  - `npx vercel teams ls`
...
- En la UI de GitHub: `Settings > Secrets and variables > Actions` añadir:
  ...
  - `VERCEL_ORG_ID` = `your-vercel-team` (o el org id exacto si lo prefieres)
...
- O con GitHub CLI (si está instalada):
  ...
  - `gh secret set VERCEL_ORG_ID --body "your-vercel-team"`
...
- Invitar a Maria al equipo Vercel (tu-equipo-vercel) (desde la consola Vercel > Team > Members > Invite).
